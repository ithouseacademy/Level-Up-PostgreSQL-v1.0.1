...
urlpatterns = [
    ...
    path('quiz/toggle-history/<int:result_id>/', views.answer_toggle_history, name='answer_toggle_history'),
    path('quiz/toggle-history/', views.answer_toggle_history_all, name='answer_toggle_history_all'),
    ...
    path('teacher/group/<int:group_id>/student/<int:student_id>/delete/', views.teacher_student_delete, name='teacher_student_delete'),
    path('teacher/group/<int:group_id>/student/<int:student_id>/archive/', views.teacher_student_archive, name='teacher_student_archive'),
    path('teacher/group/<int:group_id>/student/<int:student_id>/restore/', views.teacher_student_restore, name='teacher_student_restore'),
    path('teacher/group/<int:group_id>/bulk-delete/', views.teacher_student_bulk_delete, name='teacher_student_bulk_delete'),
    path('teacher/group/<int:group_id>/bulk-archive/', views.teacher_student_bulk_archive, name='teacher_student_bulk_archive'),
